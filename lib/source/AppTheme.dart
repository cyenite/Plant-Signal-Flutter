...
class AppTheme {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    navigationRailTheme: NavigationRailThemeData(
        selectedIconTheme:
            IconThemeData(color: WAPrimaryColor, opacity: 1, size: 24),
        unselectedIconTheme:
            IconThemeData(color: Color(0xff495057), opacity: 1, size: 24),
        backgroundColor: Color(0xffffffff),
        elevation: 3,
        selectedLabelTextStyle: TextStyle(color: WAPrimaryColor),
        unselectedLabelTextStyle: TextStyle(color: Color(0xff495057))),
    colorScheme: ColorScheme.light(
        primary: WAPrimaryColor,
        onPrimary: Colors.white,
        primaryVariant: WAPrimaryColor,
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      focusedBorder: OutlineInputBorder(
        ...
        borderSide: BorderSide(width: 1, color: WAPrimaryColor),
      ),
