          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                16.height,
                Text('Recent Payees', style: boldTextStyle(size: 18)).paddingLeft(16),
                16.height,
                ...
                16.height,
                Text("Receipt's Name", style: boldTextStyle(size: 18)).paddingLeft(16),
                16.height,
                AppTextField(
                  autoFocus: false,
                  decoration: waInputDecoration(hint: "Enter receipt's name here", bgColor: Colors.white, borderColor: Colors.grey),
                ...
                Text("Receiver's Account Number", style: boldTextStyle(size: 18)).paddingLeft(16),
                16.height,
                AppTextField(
                  autoFocus: false,
                  decoration: waInputDecoration(hint: "Enter Receiver's name here", bgColor: white),
                  textFieldType: TextFieldType.NAME,
                  keyboardType: TextInputType.name,
